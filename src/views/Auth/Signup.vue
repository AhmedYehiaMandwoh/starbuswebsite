...
export default {
  ...
  methods: {
    ...
    async signUp() {
      ...
      try {
        const response = await axios.post('https://starbusegypt.info/api/outside/signup', {
          name: this.name,
    ...
    async getAllCountries() {
      ...
      try {
        const response = await axios.get(' https://starbusegypt.info/api/outside/countries/getAllCountries');
