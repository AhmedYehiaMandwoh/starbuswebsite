                ...
                <div class="ticket-form row g-3 justify-content-center m-0" v-if="!showPRiavte">
                  ...
                  <div class="col-md-6">
                    <div class="form--group">
                      <label for="remember">{{ t('header.One_way') }}</label>
                  ...
                  <div class="col-md-6">
                    <div class="form--group">
                      ...
                      <input type="text" class="form--control" :disabled="disabled" v-model="bus_type">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form--group">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="list-group seat-details-animate">
                      ...
                      <div class="selected-seat-details">
                        ...
                        <span
                          class="list-group-item d-flex justify-content-between">{{ t('header.bus_type') }}<span>{{ myPrivate.Details.bus_type }}</span></span>
  ...
  methods: {
    ...
    async searchPrivate() {
      if (this.from_city == '' || this.to_city == '' || this.date == '') {
        ...
        try {
          const response = await axios.post('https://mdsapps.net/api/outside/private/searchPrivateBus', formData, {
